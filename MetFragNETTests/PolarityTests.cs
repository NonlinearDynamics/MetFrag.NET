...
171.044692993164 283";
			...
			Assert.That(frags[0], new FragConstraint("C10H13N1O2", "", 179.0946));
			Assert.That(frags[1], new FragConstraint("C9H10N1", "+H", 133.0891));
			Assert.That(frags[2], new FragConstraint("C9H8O1", "+H", 133.0653));
			Assert.That(frags[3], new FragConstraint("C8H7N1O1", "", 133.0528));
			Assert.That(frags[4], new FragConstraint("C8H10N1", "+H", 121.0891));			 
			Assert.That(frags[5], new FragConstraint("C8H11N1", "", 121.0891));
